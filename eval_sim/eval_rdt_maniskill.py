...
def parse_args(args=None):
    ...
    parser.add_argument("--pretrained_path", type=str, default='/home/kyji/public/public_data/models/maniskill-model/rdt/mp_rank_00_model_states.pt', help="Path to the pretrained model")
